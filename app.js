...
function addAdminPhoto(file, skipRender = false){
    ...
    return new Promise(resolve => {
        ...
        reader.onload = () => {
            ...
            // v41: agora mantém até 50 fotos cadastradas.
...
const adminPhotoInputV41 = document.getElementById("adminPhotoInput");
if(adminPhotoInputV41){
    adminPhotoInputV41.setAttribute("multiple", "multiple");
    adminPhotoInputV41.addEventListener("change", async event => {

...
const adminPhotoInputV45 = document.getElementById("adminPhotoInput");
if(adminPhotoInputV45){
    adminPhotoInputV45.setAttribute("multiple", "multiple");
    adminPhotoInputV45.multiple = true;
    adminPhotoInputV45.addEventListener("change", async event => {
